...
class _ProSubscriptionScreenState extends State<ProSubscriptionScreen> {
  ...
  bool _monthlyPressed = false;
  bool _yearlyPressed = false;
  @override
  void initState() {
    super.initState();
          ...
          child: Padding(
            ...
            child: Material(
              ...
              child: InkWell(
                onTapDown: (_) {
                  setState(() {
                    _monthlyPressed = true;
                  });
                },
                onTapCancel: () {
                  setState(() {
                    _monthlyPressed = false;
                  });
                },
                onTap: () {
                  setState(() {
                ...
                child: AnimatedScale(
                  scale: _monthlyPressed ? 0.98 : 1.0,
